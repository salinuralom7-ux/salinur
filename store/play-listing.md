...
Everything below is written to Play's character limits. Nothing here claims
anything the app does not do, which matters: Play rejects listings whose
description oversells, and a rejection costs days.
...
* **Why an app** — home screen presence, offline browsing of the service
  ...
  supported Play distribution model.
