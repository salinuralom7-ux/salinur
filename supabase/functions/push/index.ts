 ...
 * Secrets:  supabase secrets set VAPID_PUBLIC=... VAPID_PRIVATE=... VAPID_SUBJECT=mailto:info@mysheher.com
...
const VAPID_SUBJECT = Deno.env.get("VAPID_SUBJECT") ?? "mailto:info@mysheher.com";
