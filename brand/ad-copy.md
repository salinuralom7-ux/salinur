...
claims outside Guwahati.

Two audiences, and they need opposite ads. **Workers first.** A marketplace
with no workers has nothing to sell, so for the first few weeks put most of
the spend on the worker side and let the customer ads follow.

Assamese lines are marked **[AS]**. Read them aloud before using them — the
meaning is right but a native ear should pick the phrasing.

---

# 1 · Video — the worker side (30 seconds)

**Use for:** Instagram Reels, Facebook, YouTube Shorts, WhatsApp status.
**Feel:** early morning, warm, unhurried. Handheld, close.
...
# 2 · Video — the customer side (30 seconds)

**Feel:** an ordinary evening that goes wrong and then goes right.
...
| 3 | 9–15s. She opens Nearse. Types "electrician". A card: a man's face, ₹400 per visit, *Six Mile · 1.2 km away*. | *Nearest to you, first* | Now you can just look. |
...
| 6 | 26–30s. Logo. | **Nearse** · Trusted people for every job, right where you are · nearse.in | **[AS]** গুৱাহাটীত এতিয়া। |

---

# 3 · Poster and flyer — for workers

The one to print. Hand these out at hardware shops, tea stalls, auto stands,
labour chowks, tailoring shops, beauty parlours, driving schools.

**Headline**
> **আপোনাৰ কামৰ দাম আপুনিয়েই ঠিক কৰক**
> **You decide what your work is worth**

**Body**
> Nearse is a free list of Guwahati's workers. Put up your profile, choose
...
# 4 · Poster — for customers

**Headline**
> **ওচৰতে থকা মানুহ, ভৰসা কৰিব পৰা কাম**
> **The right person, right where you are**
...
> ✓ A person at Nearse checks every profile
...
Facebook wants a short headline and a longer primary text. Six pairs, three
per audience. Run them against each other and keep what works.
...
Primary text:
> Word of mouth only reaches so far. Nearse puts your name, your trade and
...
# 6 · WhatsApp broadcast and status

Short enough to read without tapping "read more".

**To workers**
> **[AS]** আপুনি যদি ইলেকট্ৰিচিয়ান, প্লাম্বাৰ, ৰান্ধনী, মিস্ত্ৰী বা ড্ৰাইভাৰ —
> নিজৰ নাম গুৱাহাটীৰ মানুহৰ আগত ৰাখক।
>
> Nearse — free list of Guwahati's workers.
...
>
> Nearse shows you the ones nearest to you with their rates, and sends your
...
* Trusted people for every job, right where you are.
* Every skill deserves an earning.
* The rate you see is the rate they set.
* Stop asking the neighbour.
* 0% commission. Always.
* Guwahati's workers, in one place.
* **[AS]** ওচৰৰ মানুহ, ভৰসাৰ কাম।

---

# 8 · Play Store short description

Already in `store/play-listing.md`, repeated here so ads and listing stay in
step:

> Book trusted maids, cooks, electricians and tutors near you in Guwahati.
...
1. Nobody is wearing a Nearse uniform, and nothing implies workers are our
   staff.
...
5. Nothing claims Nearse works outside Guwahati.
...
"verified" contradicts the page you published.
